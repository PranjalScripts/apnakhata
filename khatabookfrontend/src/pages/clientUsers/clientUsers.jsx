...
const ClientUsers = () => {
  ...
  const { showAddUserModal, handleAddUser, userAdded } = useContext(UserContext);
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <DeleteConfirmationModal
        ...
        bookName={deleteModal.user?.name}
        ...
        {filteredUsers.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-lg transition-colors duration-200 group"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 transform group-hover:scale-110 transition-transform" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="p-2 bg-blue-50 rounded-lg">
                  {editingUser ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2a1 1 0 01-1-1V6a1 1 0 112 0v1h.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.293.707V14a1 1 0 01-1 1h-1a1 1 0 110-2h2a1 1 0 012 0v3a1 1 0 11-2 0v-1a1 1 0 01-1-1V6a1 1 0 012 0v1h.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.293.707V9z" />
                    </svg>
                  ) : (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
